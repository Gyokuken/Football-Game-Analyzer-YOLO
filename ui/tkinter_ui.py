...
#     mode_menu=ctk.CTkComboBox(controls,values=[Mode.PITCH_DETECTION,Mode.PLAYER_DETECTION,Mode.BALL_DETECTION,Mode.PLAYER_TRACKING,Mode.TEAM_CLASSIFICATION,Mode.RADAR,Mode.PASS_MAP,Mode.HEATMAP])
